...
namespace Mkey
{
    public class MapController : MonoBehaviour
    {
        ...
        private LevelConstructSet LCSet { get { return GCSet.GetLevelConstructSet(BubblesPlayer.CurrentLevel); } }
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < MapLevelButtons.Count; i++)
            {
                ...
                MapLevelButtons[i].button.onClick.AddListener(() =>
                {
                    ...
                    if (MPlayer.Life <= 0 && !GCSet.UnLimited) { MGui.ShowMessage("Sorry!", "You have no lifes.", 1.5f, () => { MGui.ShowLifeShop(); }); return; }
        ...
        {
            int activeStarsCount = MPlayer.GetLevelStars(buttonNumber-1);
